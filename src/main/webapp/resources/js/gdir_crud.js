                        ...
                        str +=  "<li id='topDir_"+obj.dirLevel+"_"+obj.dirNo+"' "+
                                    ...
                                    "<div class='dirli' data-no="+obj.dirNo+" data-topno="+obj.dirTopNo+" data-level="+obj.dirLevel+">"+
                                        "<a "+  // href='/dir/get?dirNo="+obj.dirNo+"'
                                            "onclick='dirListBtn("+obj.dirLevel+", "+obj.dirNo+", "+obj.dirTopNo+", "+obj.dirGroup+")'> "+
...
function dirListBtn(dirLevel, dirNo, dirTopNo, dirGroup ) {
        ...
        // $("#top_dir_"+dirLevel+"_"+dirNo+"")                            //상위폴더 
...
//폴더추가
function gdirRegisterBtn(dirLevel, dirNo, dirTopNo, dirGroup ) {
    console.log('gdirRegisterBtn('+dirLevel+','+dirNo+','+dirTopNo+','+dirGroup+') invoked.')
