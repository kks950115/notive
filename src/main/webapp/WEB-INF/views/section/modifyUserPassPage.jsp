...
<head>
	...
	} else if (result == "passCheck-failure"){
			...
			<form action="/user/modifyUserPass" method="post">
				<fieldset class="userSection-fieldSet">
					<div class="form-input">현재 비밀번호<br>
						<input class="modifyPass-input-box" id="userPassCur" name="userPassCur" type="password" placeholder="현재 비밀번호 입력"/>
					</div>
					<div class="form-input">새 비밀번호<br>
						<input class="modifyPass-input-box" placeholder="비밀번호 (8~16자리)" name="userPass" id="userPass" type="password"/>
						<div class="checkMsg" id="checkPass"></div>
					</div>
					<div class="form-input">새 비밀번호 재입력<br>
						<input class="modifyPass-input-box" placeholder="비밀번호 재입력" name="userPassConfirm" id="userPassConfirm" type="password"/>
						<div class="checkMsg" id="checkPassConfirm"></div>
					</div>

				</fieldset>
				<Br>
				<button type="submit" class="defaultBtn" id="submitBtn-modifyUserPass">비밀번호 변경</button>
				<br>
				<button type="button" class="crossBtn" id="cancleBtn-modifyPass">취소</button>
			</form>
